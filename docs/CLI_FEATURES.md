...
### 9. Admin Console (交互式管理控制台)
- [x] `minebot admin` 或 `minebot console` - 启动交互式管理控制台
- [x] **仪表盘视图**：系统概览、状态监控、资源使用
- [x] **Bot管理界面**：启动、停止、查看、配置Bot
- [x] **服务器控制界面**：控制Minecraft和Bot服务器
- [x] **配置管理界面**：查看和修改系统配置
- [x] **日志查看器**：查看系统日志文件
- [x] **实用工具集合**：系统诊断、网络测试、备份等工具
- [x] **实时告警**：系统资源监控和告警
- [x] **自动刷新**：5秒自动更新数据
- [x] **错误恢复**：自动错误处理和系统恢复
